...
<div class="section-body">
    ...
    <form action="{{ url('/checkin')}}" method="POST" enctype="multipart/form-data">
        @csrf  
        <div class="row">
            <div class="card-body-center">
                <h4> Form Check In Guest </h4>
                ...
                <div class="form-row justify-content-center">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="number" class="form-control" value="{{old('telephone')}}" placeholder="Telephone" name="telephone"  onKeyPress="if(this.value.length==13) return false" >
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-6">
                ...
                <div class=" text-center" color="none">
                    <a class="btn btn-outline-info" href="{{ url('/indexutamaguest')}}" > Back </a>
